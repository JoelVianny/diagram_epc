 ...
 */
export function rhomb1(svg, canvasData, rhombData) {
	const templ = `
		...
		<path data-key="main" d="M-21 0 L0 -21 21 0 L0 21 Z" stroke-width="18" stroke-linejoin="round"	stroke="#FFF455" fill="#FFF455" />
		<text data-key="text" x="0" y="10" text-anchor="middle" style="pointer-events: none; font-size: 36px;" fill="#fff" transform="rotate(360)">&#215;</text>`;
