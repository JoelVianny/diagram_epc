 ...
 */
export function square4(svg, canvasData, rectData) {
    ...
    <rect data-key="main" width="${rectData.w}" height="${rectData.h}" x="${-rectData.w / 2}" y="${-rectData.h / 2}" fill="#fff" stroke="#00224D" stroke-width="1" />
