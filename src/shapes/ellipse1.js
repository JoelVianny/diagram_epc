 ...
 */
export function ellipse1(svg, canvasData, ellipseData) {
    ...
    <line x1="-58" y1="-36" x2="-58" y2="36" stroke="#fff" stroke-width="1" />`; // Added vertical line 10 units to the left
    ...
    const shape = shapeCreate(svg, canvasData, ellipseData, templ,
        {
            ...
            left: { dir: 'left', position: { x: -58, y: 0 } }, // Adjusted left connector position
    ...
    function resize() {
        ...
        shape.cons.left.position.x = -ellipseData.rx - 10; // Adjusted left connector position
