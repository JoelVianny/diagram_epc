...
export function rect(svg, canvasData, rectData) {
	...
	const templ = `
	<rect data-key="outer" data-evt-no data-evt-index="2" width="${rectData.w + 48}" height="${rectData.h + 48}" x="${-rectData.w / 2 - 24}" y="${-rectData.h / 2 - 24}" fill="transparent" stroke="transparent" stroke-width="0" />
	<rect data-key="main" width="${rectData.w}" height="${rectData.h}" x="${-rectData.w / 2}" y="${-rectData.h / 2}" rx="15" ry="15" fill="#1aaee5" stroke="#fff" stroke-width="1" />
